...
NB. Sample definitions for unicode display.
NB. Enter the Mnemonic name of a primitive at the first of a line
NB. followed by the hexidecimal value of the unicode character to
NB. display in its place. If you want more than one unicode
NB. character to represent a mnemonic then separate the hexidecimal
NB. values by a space. For example:
NB.  "Toy 2211 2260" would make "Toy" display as "∑≠".
'Uname Ucode'=: |:<"0;:&><;._2]0 : 0
Sum      2211
Product  220f
Infinity 221e
NE       2260
